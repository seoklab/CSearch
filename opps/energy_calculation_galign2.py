...
def energy_calc(input_mols, templ_file_path):
    ...
    for ii, i in enumerate(input_mols):
        ...
        ff = str(subprocess.run(["galign",f"{ii}_f2.mol2","/home/hakjean/galaxy2/developments/MolGen/CSearch_revised/data/6M0K_ori_2.mol2"],capture_output=True)).split()
        print(ff)
